(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,79799,e=>{"use strict";var t=e.i(47662);let r="reflectionFunction",o=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},70619,e=>{"use strict";var t=e.i(47662);let r="lightUboDeclaration",o=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([],97412);let i="clusteredLightingFunctions",a=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],98135)},70070,e=>{"use strict";var t=e.i(47662);let r="shadowsFragmentFunctions",o=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},20385,e=>{"use strict";var t=e.i(47662);let r="lightFragment",o=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])}]);