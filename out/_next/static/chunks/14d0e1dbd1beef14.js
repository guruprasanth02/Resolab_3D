...
#endif
#endif
`;f.ShaderStore.IncludesShadersStoreWGSL[t]||(f.ShaderStore.IncludesShadersStoreWGSL[t]=n),e.s([],36730)},8689,e=>{"use strict";var f=e.i(47662);e.i(64500),e.i(2241),e.i(45595),e.i(36730);let a="hdrFilteringPixelShader",r=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform alphaG: f32;var inputTextureSampler: sampler;var inputTexture: texture_cube<f32>;uniform vFilteringInfo: vec2f;uniform hdrScale: f32;varying direction: vec3f;@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var color: vec3f=radiance(uniforms.alphaG,inputTexture,inputTextureSampler,input.direction,uniforms.vFilteringInfo);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;f.ShaderStore.ShadersStoreWGSL[a]||(f.ShaderStore.ShadersStoreWGSL[a]=r),e.s(["hdrFilteringPixelShaderWGSL",0,{name:a,shader:r}])}]);