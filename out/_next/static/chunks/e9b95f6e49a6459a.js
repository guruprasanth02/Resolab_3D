(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,85671,e=>{"use strict";var o=e.i(47662);let t="motionBlurPixelShader",r=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float motionStrength;uniform float motionScale;uniform vec2 screenSize;
#ifdef OBJECT_BASED
...
`;o.ShaderStore.ShadersStore[t]||(o.ShaderStore.ShadersStore[t]=r),e.s(["motionBlurPixelShader",0,{name:t,shader:r}])}]);