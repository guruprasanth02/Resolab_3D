...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[i]||(t.ShaderStore.IncludesShadersStore[i]=n),e.s([],33879)},90480,e=>{"use strict";var t=e.i(47662);e.i(87714),e.i(28993),e.i(7199),e.i(33879);let a="iblDominantDirectionPixelShader",o=`precision highp sampler2D;precision highp samplerCube;
...
lightDir/=float(NUM_SAMPLES);gl_FragColor=vec4(lightDir,1.0);}`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["iblDominantDirectionPixelShader",0,{name:a,shader:o}])}]);