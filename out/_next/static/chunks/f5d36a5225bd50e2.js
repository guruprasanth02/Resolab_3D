(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,55334,e=>{"use strict";var t=e.i(47662);let o="ssao2PixelShader",r=`precision highp float;uniform sampler2D textureSampler;varying vec2 vUV;
#ifdef SSAO
...
#endif
`;t.ShaderStore.ShadersStore[o]||(t.ShaderStore.ShadersStore[o]=r),e.s(["ssao2PixelShader",0,{name:o,shader:r}])}]);