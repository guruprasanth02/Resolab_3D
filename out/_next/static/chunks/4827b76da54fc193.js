(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,54737,e=>{"use strict";var r=e.i(47662);let i="iblCdfDebugPixelShader",t=`precision highp samplerCube;
#define PI 3.1415927
...
`;r.ShaderStore.ShadersStore[i]||(r.ShaderStore.ShadersStore[i]=t),e.s(["iblCdfDebugPixelShader",0,{name:i,shader:t}])}]);