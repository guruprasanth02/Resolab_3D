...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=f),e.s([],60334);let n="clipPlaneFragment",i=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=i),e.s([],83784)},7822,e=>{"use strict";var r=e.i(47662);e.i(64500),e.i(60334),e.i(83784);let a="glowMapGenerationPixelShader",f=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;r.ShaderStore.ShadersStoreWGSL[a]||(r.ShaderStore.ShadersStoreWGSL[a]=f),e.s(["glowMapGenerationPixelShaderWGSL",0,{name:a,shader:f}])}]);