(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52118,e=>{"use strict";var r=e.i(47662);let i="iblCdfyPixelShader",t=`varying vUV : vec2f;
...
fragmentOutputs.color= vec4f(cdfy,0.0,0.0,1.0);}`;r.ShaderStore.ShadersStoreWGSL[i]||(r.ShaderStore.ShadersStoreWGSL[i]=t),e.s(["iblCdfyPixelShaderWGSL",0,{name:i,shader:t}])}]);