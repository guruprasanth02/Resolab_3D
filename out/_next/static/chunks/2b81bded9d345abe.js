...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=a),e.s([])},45595,e=>{"use strict";var r=e.i(47662);let t="pbrBRDFFunctions",a=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=a),e.s([])},71082,e=>{"use strict";var r=e.i(47662);let t="screenSpaceRayTrace",a=`fn distanceSquared(a: vec2f,b: vec2f)->f32 { 
var temp=a-b; 
...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=a),e.s([])},7495,e=>{"use strict";var r=e.i(47662);e.i(64500),e.i(45595),e.i(71082);let t="screenSpaceReflection2PixelShader",a=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;r.ShaderStore.ShadersStoreWGSL[t]||(r.ShaderStore.ShadersStoreWGSL[t]=a),e.s(["screenSpaceReflection2PixelShaderWGSL",0,{name:t,shader:a}])}]);