(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,35716,e=>{"use strict";var i=e.i(47662);let t="reflectionFunction",o=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=o),e.s([])},82656,31116,e=>{"use strict";var i=e.i(47662);let t="lightFragmentDeclaration",o=`#ifdef LIGHT{X}
