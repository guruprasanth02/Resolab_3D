...
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=t),e.s([])},56216,e=>{"use strict";var r=e.i(47662);e.i(64500);let a="layerPixelShader",t=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform color: vec4f;
...
}`;r.ShaderStore.ShadersStoreWGSL[a]||(r.ShaderStore.ShadersStoreWGSL[a]=t),e.s(["layerPixelShaderWGSL",0,{name:a,shader:t}])}]);