(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,24335,e=>{"use strict";var r=e.i(47662);let l="depthOfFieldMergePixelShader",t=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;var circleOfConfusionSamplerSampler: sampler;var circleOfConfusionSampler: texture_2d<f32>;var blurStep0Sampler: sampler;var blurStep0: texture_2d<f32>;
#if BLUR_LEVEL>0
...
`;r.ShaderStore.ShadersStoreWGSL[l]||(r.ShaderStore.ShadersStoreWGSL[l]=t),e.s(["depthOfFieldMergePixelShaderWGSL",0,{name:l,shader:t}])}]);