(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,32992,e=>{"use strict";var r=e.i(47662);let a="circleOfConfusionPixelShader",c=`varying vUV: vec2f;var depthSamplerSampler: sampler;var depthSampler: texture_2d<f32>;
...
`;r.ShaderStore.ShadersStoreWGSL[a]||(r.ShaderStore.ShadersStoreWGSL[a]=c),e.s(["circleOfConfusionPixelShaderWGSL",0,{name:a,shader:c}])}]);