(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,55870,e=>{"use strict";var r=e.i(47662);let f="iblCdfDebugPixelShader",c=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;r.ShaderStore.ShadersStoreWGSL[f]||(r.ShaderStore.ShadersStoreWGSL[f]=c),e.s(["iblCdfDebugPixelShaderWGSL",0,{name:f,shader:c}])}]);