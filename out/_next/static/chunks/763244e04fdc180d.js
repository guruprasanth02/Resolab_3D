(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,47193,e=>{"use strict";var r=e.i(47662);let t="logDepthDeclaration",o=`#ifdef LOGARITHMICDEPTH
uniform logarithmicDepthConstant: f32;varying vFragmentDepth: f32;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},31343,e=>{"use strict";var r=e.i(47662);let t="logDepthVertex",o=`#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},4340,e=>{"use strict";var r=e.i(47662);let t="fogVertex",o=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},22352,5748,e=>{"use strict";var r=e.i(47662);let t="clipPlaneVertexDeclaration",o=`#ifdef CLIPPLANE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],22352);let i="clipPlaneVertex",n=`#ifdef CLIPPLANE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=n),e.s([],5748)},62549,e=>{"use strict";var r=e.i(47662);let t="fogVertexDeclaration",o=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},30885,e=>{"use strict";var r=e.i(47662);e.i(22352),e.i(62549),e.i(47193),e.i(5748),e.i(4340),e.i(31343);let t="particlesVertexShader",o=`attribute position: vec3f;attribute color: vec4f;attribute angle: f32;attribute size: vec2f;
#ifdef ANIMATESHEET
...
}`;r.ShaderStore.ShadersStoreWGSL[t]||(r.ShaderStore.ShadersStoreWGSL[t]=o),e.s(["particlesVertexShaderWGSL",0,{name:t,shader:o}])}]);