(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,7199,e=>{"use strict";var i=e.i(47662);let t="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([])},59791,e=>{"use strict";var i=e.i(47662);let t="meshUboDeclaration",n=`#ifdef WEBGL2
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=a),e.s([],30514)},24232,29344,41179,e=>{"use strict";var i=e.i(47662);let t="lightVxFragmentDeclaration",n=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([],24232);let o="lightVxUboDeclaration",a=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=a),e.s([],29344);let r="shadowsVertex",f=`#ifdef SHADOWS
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=f),e.s([],41179)},77414,e=>{"use strict";var i=e.i(47662);let t="vertexColorMixing",n=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([])},80801,26477,3590,39199,20554,45898,84894,63990,e=>{"use strict";var i=e.i(47662);let t="decalVertexDeclaration",n=`#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([],80801);let o="uvAttributeDeclaration",a=`#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=a),e.s([],26477);let r="prePassVertexDeclaration",f=`#ifdef PREPASS
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=f),e.s([],3590);let c="samplerVertexDeclaration",l=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying vec2 v_VARYINGNAME_UV;
#endif
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=l),e.s([],39199);let d="bumpVertexDeclaration",E=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[d]||(i.ShaderStore.IncludesShadersStore[d]=E),e.s([],20554);let s="prePassVertex",_=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[s]||(i.ShaderStore.IncludesShadersStore[s]=_),e.s([],45898);let v="uvVariableDeclaration",N=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;i.ShaderStore.IncludesShadersStore[v]||(i.ShaderStore.IncludesShadersStore[v]=N),e.s([],84894);let I="samplerVertexImplementation",m=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[I]||(i.ShaderStore.IncludesShadersStore[I]=m),e.s([],63990)},91473,e=>{"use strict";var i=e.i(47662);e.i(80801);let t="pbrVertexDeclaration",n=`uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
...
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.i(12159),e.i(26477),e.i(66058),e.i(87714),e.i(7199),e.i(68489),e.i(58483),e.i(8559),e.i(3590),e.i(39199),e.i(30514),e.i(20554),e.i(59092),e.i(91999),e.i(24232),e.i(29344),e.i(52690),e.i(10370),e.i(45224),e.i(88335),e.i(16389),e.i(32817),e.i(59862),e.i(2947),e.i(45898),e.i(84894),e.i(63990),e.i(76154),e.i(34760),e.i(3011),e.i(41179),e.i(77414),e.i(41746);let o="pbrVertexShader",a=`#define PBR_VERTEX_SHADER
...
`;i.ShaderStore.ShadersStore[o]||(i.ShaderStore.ShadersStore[o]=a),e.s(["pbrVertexShader",0,{name:o,shader:a}],91473)}]);