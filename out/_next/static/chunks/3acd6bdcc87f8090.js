...
`;f.ShaderStore.IncludesShadersStoreWGSL[r]||(f.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},45595,e=>{"use strict";var f=e.i(47662);let r="pbrBRDFFunctions",a=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;f.ShaderStore.IncludesShadersStoreWGSL[r]||(f.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],2241);let t="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;f.ShaderStore.IncludesShadersStoreWGSL[t]||(f.ShaderStore.IncludesShadersStoreWGSL[t]=n),e.s([],36730)},88915,e=>{"use strict";var f=e.i(47662);e.i(64500),e.i(2241),e.i(45595),e.i(36730);let r="hdrIrradianceFilteringPixelShader",a=`#include<helperFunctions>
...
#endif
);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;f.ShaderStore.ShadersStoreWGSL[r]||(f.ShaderStore.ShadersStoreWGSL[r]=a),e.s(["hdrIrradianceFilteringPixelShaderWGSL",0,{name:r,shader:a}])}]);