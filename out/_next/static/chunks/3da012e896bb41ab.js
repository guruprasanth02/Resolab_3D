...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=a),e.s([],70456);let f="instancesVertex",s=`#ifdef INSTANCES
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[f]||(t.ShaderStore.IncludesShadersStoreWGSL[f]=s),e.s([],93828);let d="bonesVertex",o=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[d]||(t.ShaderStore.IncludesShadersStoreWGSL[d]=o),e.s([],31752);let u="bakedVertexAnimation",l=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[u]||(t.ShaderStore.IncludesShadersStoreWGSL[u]=l),e.s([],26106)},33077,e=>{"use strict";var t=e.i(47662);let r="instancesDeclaration",i=`#ifdef INSTANCES
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},64104,e=>{"use strict";var t=e.i(47662);let r="vertexColorMixing",i=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},39363,e=>{"use strict";var t=e.i(47662);e.i(97603),e.i(70456),e.i(22352),e.i(62549),e.i(33077),e.i(93828),e.i(31752),e.i(26106),e.i(5748),e.i(4340),e.i(64104);let r="colorVertexShader",i=`attribute position: vec3f;
#ifdef VERTEXCOLOR
...
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["colorVertexShaderWGSL",0,{name:r,shader:i}])}]);