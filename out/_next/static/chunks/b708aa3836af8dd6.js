...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[i]||(t.ShaderStore.IncludesShadersStore[i]=n),e.s([],33879)},49306,e=>{"use strict";var t=e.i(47662);e.i(87714),e.i(28993),e.i(7199),e.i(33879);let a="hdrIrradianceFilteringPixelShader",o=`#include<helperFunctions>
...
,icdfTexture
#endif
);gl_FragColor=vec4(color*hdrScale,1.0);}`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["hdrIrradianceFilteringPixelShader",0,{name:a,shader:o}])}]);