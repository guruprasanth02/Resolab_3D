...
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.i(12159),e.i(66058);let r="pbrFragmentExtraDeclaration",o=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=o),e.i(82656),e.i(31116),e.i(30550);let t="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=f);let c="pbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=l),e.i(57325),e.i(81239),e.i(45224),e.i(71154),e.i(87714);let d="subSurfaceScatteringFunctions",s=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;i.ShaderStore.IncludesShadersStore[d]||(i.ShaderStore.IncludesShadersStore[d]=s),e.i(28993);let E="pbrHelperFunctions",R=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.ShaderStore.IncludesShadersStore[E]||(i.ShaderStore.IncludesShadersStore[E]=R),e.i(77772),e.i(67654),e.i(30514),e.i(78153);let u="pbrDirectLightingSetupFunctions",C=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[u]||(i.ShaderStore.IncludesShadersStore[u]=C);let S="pbrDirectLightingFalloffFunctions",A=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;i.ShaderStore.IncludesShadersStore[S]||(i.ShaderStore.IncludesShadersStore[S]=A),e.i(7199),e.i(33879);let m="pbrDirectLightingFunctions",I=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;i.ShaderStore.IncludesShadersStore[m]||(i.ShaderStore.IncludesShadersStore[m]=I);let v="pbrIBLFunctions",O=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.ShaderStore.IncludesShadersStore[v]||(i.ShaderStore.IncludesShadersStore[v]=O),e.i(37187),e.i(610),e.i(35716),e.i(75222);let N="pbrBlockAlbedoOpacity",T=`struct albedoOpacityOutParams
...
`;i.ShaderStore.IncludesShadersStore[N]||(i.ShaderStore.IncludesShadersStore[N]=T);let L="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;i.ShaderStore.IncludesShadersStore[L]||(i.ShaderStore.IncludesShadersStore[L]=g);let p="pbrBlockAmbientOcclusion",D=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;i.ShaderStore.IncludesShadersStore[p]||(i.ShaderStore.IncludesShadersStore[p]=D);let h="pbrBlockAlphaFresnel",_=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[h]||(i.ShaderStore.IncludesShadersStore[h]=_);let M="pbrBlockAnisotropic",F=`#ifdef ANISOTROPIC
...
#endif
`;i.ShaderStore.IncludesShadersStore[M]||(i.ShaderStore.IncludesShadersStore[M]=F);let P="pbrBlockReflection",U=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStore[P]||(i.ShaderStore.IncludesShadersStore[P]=U);let b="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;i.ShaderStore.IncludesShadersStore[b]||(i.ShaderStore.IncludesShadersStore[b]=B);let y="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[y]||(i.ShaderStore.IncludesShadersStore[y]=G);let V="pbrBlockIridescence",H=`struct iridescenceOutParams
...
#endif
`;i.ShaderStore.IncludesShadersStore[V]||(i.ShaderStore.IncludesShadersStore[V]=H);let x="pbrBlockSubSurface",W=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[x]||(i.ShaderStore.IncludesShadersStore[x]=W),e.i(95208);let Y="pbrBlockReflectance0",X=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;i.ShaderStore.IncludesShadersStore[Y]||(i.ShaderStore.IncludesShadersStore[Y]=X);let k="pbrClusteredLightingFunctions",w=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[k]||(i.ShaderStore.IncludesShadersStore[k]=w),e.i(79939);let z="pbrBlockNormalGeometric",K=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;i.ShaderStore.IncludesShadersStore[z]||(i.ShaderStore.IncludesShadersStore[z]=K),e.i(87126);let q="pbrBlockNormalFinal",Z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[q]||(i.ShaderStore.IncludesShadersStore[q]=Z),e.i(79795);let J="pbrBlockLightmapInit",j=`#ifdef LIGHTMAP
...
#endif
`;i.ShaderStore.IncludesShadersStore[J]||(i.ShaderStore.IncludesShadersStore[J]=j);let Q="pbrBlockGeometryInfo",$=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[Q]||(i.ShaderStore.IncludesShadersStore[Q]=$);let ee="pbrBlockReflectance",ei=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[ee]||(i.ShaderStore.IncludesShadersStore[ee]=ei);let en="pbrBlockDirectLighting",ea=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;i.ShaderStore.IncludesShadersStore[en]||(i.ShaderStore.IncludesShadersStore[en]=ea),e.i(60096);let er="pbrBlockFinalLitComponents",eo=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[er]||(i.ShaderStore.IncludesShadersStore[er]=eo);let et="pbrBlockFinalUnlitComponents",ef=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;i.ShaderStore.IncludesShadersStore[et]||(i.ShaderStore.IncludesShadersStore[et]=ef);let ec="pbrBlockFinalColorComposition",el=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.ShaderStore.IncludesShadersStore[ec]||(i.ShaderStore.IncludesShadersStore[ec]=el),e.i(49426),e.i(72079);let ed="pbrBlockImageProcessing",es=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.ShaderStore.IncludesShadersStore[ed]||(i.ShaderStore.IncludesShadersStore[ed]=es);let eE="pbrBlockPrePass",eR=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[eE]||(i.ShaderStore.IncludesShadersStore[eE]=eR),e.i(56015);let eu="pbrDebug",eC=`#if DEBUGMODE>0
...
#endif
`;i.ShaderStore.IncludesShadersStore[eu]||(i.ShaderStore.IncludesShadersStore[eu]=eC);let eS="pbrPixelShader",eA=`#define PBR_FRAGMENT_SHADER
...
`;i.ShaderStore.ShadersStore[eS]||(i.ShaderStore.ShadersStore[eS]=eA),e.s(["pbrPixelShader",0,{name:eS,shader:eA}],48721)}]);