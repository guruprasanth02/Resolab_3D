(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,64500,e=>{"use strict";var f=e.i(47662);let a="helperFunctions",r=`const PI: f32=3.1415926535897932384626433832795;const TWO_PI: f32=6.283185307179586;const HALF_PI: f32=1.5707963267948966;const RECIPROCAL_PI: f32=0.3183098861837907;const RECIPROCAL_PI2: f32=0.15915494309189535;const RECIPROCAL_PI4: f32=0.07957747154594767;const HALF_MIN: f32=5.96046448e-08; 
...
`;f.ShaderStore.IncludesShadersStoreWGSL[a]||(f.ShaderStore.IncludesShadersStoreWGSL[a]=r),e.s([])},45595,e=>{"use strict";var f=e.i(47662);let a="pbrBRDFFunctions",r=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;f.ShaderStore.IncludesShadersStoreWGSL[a]||(f.ShaderStore.IncludesShadersStoreWGSL[a]=r),e.s([],2241);let t="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;f.ShaderStore.IncludesShadersStoreWGSL[t]||(f.ShaderStore.IncludesShadersStoreWGSL[t]=n),e.s([],36730)},50820,e=>{"use strict";var f=e.i(47662);e.i(64500),e.i(2241),e.i(45595),e.i(36730);let a="iblDominantDirectionPixelShader",r=`#include<helperFunctions>
...
lightDir/=vec3f(f32(NUM_SAMPLES));fragmentOutputs.color=vec4f(lightDir,1.0);}`;f.ShaderStore.ShadersStoreWGSL[a]||(f.ShaderStore.ShadersStoreWGSL[a]=r),e.s(["iblDominantDirectionPixelShaderWGSL",0,{name:a,shader:r}])}]);