(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,59791,e=>{"use strict";var t=e.i(47662);let a="meshUboDeclaration",o=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([])},66058,e=>{"use strict";var t=e.i(47662);let a="mainUVVaryingDeclaration",o=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([])},7199,e=>{"use strict";var t=e.i(47662);let a="pbrBRDFFunctions",o=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([])},28993,33879,e=>{"use strict";var t=e.i(47662);let a="importanceSampling",o=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([],28993);let i="hdrFilteringFunctions",n=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[i]||(t.ShaderStore.IncludesShadersStore[i]=n),e.s([],30514)},78144,45107,e=>{"use strict";var t=e.i(47662);let a="prePassDeclaration",o=`#ifdef PREPASS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([],78144);let i="oitDeclaration",n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;t.ShaderStore.IncludesShadersStore[i]||(t.ShaderStore.IncludesShadersStore[i]=n),e.s([],45107)},58492,e=>{"use strict";var t=e.i(47662);let a="decalFragmentDeclaration",o=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([])},75222,79795,56015,e=>{"use strict";var t=e.i(47662);let a="decalFragment",o=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=o),e.s([],75222);let i="depthPrePass",n=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;t.ShaderStore.IncludesShadersStore[i]||(t.ShaderStore.IncludesShadersStore[i]=n),e.s([],79795);let r="oitFragment",l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=l),e.s([],56015)}]);