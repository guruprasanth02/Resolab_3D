...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=a),e.s([])},4560,27662,e=>{"use strict";var r=e.i(47662);let t="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=a),e.s([],4560);let n="imageProcessingFunctions",o=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=o),e.s([],27662)},62222,e=>{"use strict";var r=e.i(47662);e.i(4560),e.i(64500),e.i(27662);let t="imageProcessingPixelShader",a=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
...
#endif
#endif
fragmentOutputs.color=result;}`;r.ShaderStore.ShadersStoreWGSL[t]||(r.ShaderStore.ShadersStoreWGSL[t]=a),e.s(["imageProcessingPixelShaderWGSL",0,{name:t,shader:a}])}]);