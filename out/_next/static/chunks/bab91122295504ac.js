(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,60896,e=>{"use strict";var t=e.i(47662);let r="sceneUboDeclaration",i=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([],22352);let n="clipPlaneVertex",f=`#ifdef CLIPPLANE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],5748)},97603,70456,93828,31752,26106,e=>{"use strict";var t=e.i(47662);let r="bonesDeclaration",i=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([],97603);let n="bakedVertexAnimationDeclaration",f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],70456);let a="instancesVertex",d=`#ifdef INSTANCES
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[a]||(t.ShaderStore.IncludesShadersStoreWGSL[a]=d),e.s([],93828);let s="bonesVertex",o=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[s]||(t.ShaderStore.IncludesShadersStoreWGSL[s]=o),e.s([],31752);let u="bakedVertexAnimation",m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[u]||(t.ShaderStore.IncludesShadersStoreWGSL[u]=m),e.s([],26106)},33077,e=>{"use strict";var t=e.i(47662);let r="instancesDeclaration",i=`#ifdef INSTANCES
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},77676,33883,34091,47232,e=>{"use strict";var t=e.i(47662);let r="morphTargetsVertexGlobalDeclaration",i=`#ifdef MORPHTARGETS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([],77676);let n="morphTargetsVertexDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],33883);let a="morphTargetsVertexGlobal",d=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[a]||(t.ShaderStore.IncludesShadersStoreWGSL[a]=d),e.s([],34091);let s="morphTargetsVertex",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[s]||(t.ShaderStore.IncludesShadersStoreWGSL[s]=o),e.s([],47232)},19874,e=>{"use strict";var t=e.i(47662);let r="bumpVertex",i=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},38141,e=>{"use strict";var t=e.i(47662);e.i(97603),e.i(70456),e.i(77676),e.i(33883),e.i(33077),e.i(60896),e.i(22352),e.i(34091),e.i(47232),e.i(93828),e.i(31752),e.i(26106),e.i(5748),e.i(19874);let r="geometryVertexShader",i=`#include<bonesDeclaration>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["geometryVertexShaderWGSL",0,{name:r,shader:i}])}]);