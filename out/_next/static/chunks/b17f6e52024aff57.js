(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,41101,e=>{"use strict";var t=e.i(47662);e.i(87714);let i="iblIcdfPixelShader",o=`precision highp sampler2D;
...
`;t.ShaderStore.ShadersStore[i]||(t.ShaderStore.ShadersStore[i]=o),e.s(["iblIcdfPixelShader",0,{name:i,shader:o}])}]);