(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,76395,e=>{"use strict";var i=e.i(47662);e.i(84972);let o="backgroundUboDeclaration",t=`layout(std140,column_major) uniform;uniform Material
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},5622,e=>{"use strict";var i=e.i(47662);e.i(78153),e.i(95208);let o="lightsFragmentFunctions",t=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},35142,e=>{"use strict";var i=e.i(47662);let o="backgroundFragmentDeclaration",t=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.i(76395),e.i(87714),e.i(35716),e.i(57325),e.i(82656),e.i(31116),e.i(5622),e.i(67654),e.i(77772),e.i(45224),e.i(81239),e.i(71154);let r="intersectionFunctions",l=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=l),e.i(79939),e.i(60096),e.i(49426),e.i(72079);let n="backgroundPixelShader",f=`#ifdef TEXTURELODSUPPORT
...
`;i.ShaderStore.ShadersStore[n]||(i.ShaderStore.ShadersStore[n]=f),e.s(["backgroundPixelShader",0,{name:n,shader:f}],35142)}]);