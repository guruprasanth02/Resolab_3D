(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,22352,5748,e=>{"use strict";var t=e.i(47662);let r="clipPlaneVertexDeclaration",i=`#ifdef CLIPPLANE
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[s]||(t.ShaderStore.IncludesShadersStoreWGSL[s]=o),e.s([],47232)},56224,e=>{"use strict";var t=e.i(47662);e.i(97603),e.i(70456),e.i(77676),e.i(33883),e.i(22352),e.i(33077),e.i(34091),e.i(47232),e.i(93828),e.i(31752),e.i(26106),e.i(5748);let r="depthVertexShader",i=`attribute position: vec3f;
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["depthVertexShaderWGSL",0,{name:r,shader:i}])}]);