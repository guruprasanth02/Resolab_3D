(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,5285,e=>{"use strict";var i=e.i(47662);e.i(51894),e.i(13871),e.i(65167),e.i(72033);let r="pbrFragmentExtraDeclaration",a=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[r]||(i.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.i(70619),e.i(20928);let n="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[n]||(i.ShaderStore.IncludesShadersStoreWGSL[n]=f);let t="pbrFragmentSamplersDeclaration",o=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[t]||(i.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.i(4560),e.i(60334),e.i(47193),e.i(53270),e.i(64500);let c="subSurfaceScatteringFunctions",l=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;i.ShaderStore.IncludesShadersStoreWGSL[c]||(i.ShaderStore.IncludesShadersStoreWGSL[c]=l),e.i(2241);let d="pbrHelperFunctions",s=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[d]||(i.ShaderStore.IncludesShadersStoreWGSL[d]=s),e.i(27662),e.i(70070),e.i(85633),e.i(97412);let E="pbrDirectLightingSetupFunctions",S=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[E]||(i.ShaderStore.IncludesShadersStoreWGSL[E]=S);let u="pbrDirectLightingFalloffFunctions",R=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;i.ShaderStore.IncludesShadersStoreWGSL[u]||(i.ShaderStore.IncludesShadersStoreWGSL[u]=R),e.i(45595),e.i(36730),e.i(98135);let m="pbrBlockReflectance0",v=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[m]||(i.ShaderStore.IncludesShadersStoreWGSL[m]=v);let C="pbrDirectLightingFunctions",p=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[C]||(i.ShaderStore.IncludesShadersStoreWGSL[C]=p);let A="pbrIBLFunctions",I=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[A]||(i.ShaderStore.IncludesShadersStoreWGSL[A]=I),e.i(58420),e.i(51357),e.i(79799),e.i(49637);let O="pbrBlockAlbedoOpacity",N=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;i.ShaderStore.IncludesShadersStoreWGSL[O]||(i.ShaderStore.IncludesShadersStoreWGSL[O]=N);let L="pbrBlockReflectivity",T=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;i.ShaderStore.IncludesShadersStoreWGSL[L]||(i.ShaderStore.IncludesShadersStoreWGSL[L]=T);let g="pbrBlockAmbientOcclusion",h=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;i.ShaderStore.IncludesShadersStoreWGSL[g]||(i.ShaderStore.IncludesShadersStoreWGSL[g]=h);let D="pbrBlockAlphaFresnel",_=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[D]||(i.ShaderStore.IncludesShadersStoreWGSL[D]=_);let M="pbrBlockAnisotropic",F=`#ifdef ANISOTROPIC
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[M]||(i.ShaderStore.IncludesShadersStoreWGSL[M]=F);let P="pbrBlockReflection",U=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[P]||(i.ShaderStore.IncludesShadersStoreWGSL[P]=U);let b="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[b]||(i.ShaderStore.IncludesShadersStoreWGSL[b]=B);let G="pbrBlockClearcoat",y=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[G]||(i.ShaderStore.IncludesShadersStoreWGSL[G]=y);let V="pbrBlockIridescence",x=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[V]||(i.ShaderStore.IncludesShadersStoreWGSL[V]=x);let H="pbrBlockSubSurface",W=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[H]||(i.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(83784);let Y="pbrBlockNormalGeometric",w=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[Y]||(i.ShaderStore.IncludesShadersStoreWGSL[Y]=w),e.i(76632);let k="pbrBlockNormalFinal",X=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[k]||(i.ShaderStore.IncludesShadersStoreWGSL[k]=X),e.i(16507);let z="pbrBlockLightmapInit",K=`#ifdef LIGHTMAP
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[z]||(i.ShaderStore.IncludesShadersStoreWGSL[z]=K);let q="pbrBlockGeometryInfo",Z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[q]||(i.ShaderStore.IncludesShadersStoreWGSL[q]=Z);let j="pbrBlockReflectance",J=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[j]||(i.ShaderStore.IncludesShadersStoreWGSL[j]=J);let Q="pbrBlockDirectLighting",$=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[Q]||(i.ShaderStore.IncludesShadersStoreWGSL[Q]=$),e.i(20385);let ee="pbrBlockFinalLitComponents",ei=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[ee]||(i.ShaderStore.IncludesShadersStoreWGSL[ee]=ei);let er="pbrBlockFinalUnlitComponents",ea=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;i.ShaderStore.IncludesShadersStoreWGSL[er]||(i.ShaderStore.IncludesShadersStoreWGSL[er]=ea);let en="pbrBlockFinalColorComposition",ef=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.ShaderStore.IncludesShadersStoreWGSL[en]||(i.ShaderStore.IncludesShadersStoreWGSL[en]=ef),e.i(82742),e.i(75587);let et="pbrBlockImageProcessing",eo=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[et]||(i.ShaderStore.IncludesShadersStoreWGSL[et]=eo);let ec="pbrBlockPrePass",el=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[ec]||(i.ShaderStore.IncludesShadersStoreWGSL[ec]=el),e.i(70177);let ed="pbrDebug",es=`#if DEBUGMODE>0
...
#endif
`;i.ShaderStore.IncludesShadersStoreWGSL[ed]||(i.ShaderStore.IncludesShadersStoreWGSL[ed]=es);let eE="pbrPixelShader",eS=`#define PBR_FRAGMENT_SHADER
...
`;i.ShaderStore.ShadersStoreWGSL[eE]||(i.ShaderStore.ShadersStoreWGSL[eE]=eS),e.s(["pbrPixelShaderWGSL",0,{name:eE,shader:eS}],5285)}]);