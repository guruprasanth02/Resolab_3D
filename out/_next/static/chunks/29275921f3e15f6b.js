(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,30409,a=>{"use strict";var e=a.i(47662);let o="fxaaPixelShader",l=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=TEXTUREFUNC(textureSampler,posM,0.0);
#endif
}`;e.ShaderStore.ShadersStore[o]||(e.ShaderStore.ShadersStore[o]=l),a.s(["fxaaPixelShader",0,{name:o,shader:l}])}]);