...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([])},4560,27662,e=>{"use strict";var r=e.i(47662);let t="imageProcessingDeclaration",i=`#ifdef EXPOSURE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([],4560);let o="imageProcessingFunctions",f=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;r.ShaderStore.IncludesShadersStoreWGSL[o]||(r.ShaderStore.IncludesShadersStoreWGSL[o]=f),e.s([],27662)},82742,e=>{"use strict";var r=e.i(47662);let t="logDepthFragment",i=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([])},60334,83784,e=>{"use strict";var r=e.i(47662);let t="clipPlaneFragmentDeclaration",i=`#ifdef CLIPPLANE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([],60334);let o="clipPlaneFragment",f=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[o]||(r.ShaderStore.IncludesShadersStoreWGSL[o]=f),e.s([],83784)},53270,75587,e=>{"use strict";var r=e.i(47662);let t="fogFragmentDeclaration",i=`#ifdef FOG
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([],53270);let o="fogFragment",f=`#ifdef FOG
...
return result;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([])},11238,e=>{"use strict";var r=e.i(47662);e.i(44444),e.i(64500),e.i(79799),e.i(4560),e.i(70619),e.i(31349),e.i(70070),e.i(27662),e.i(47193),e.i(60334),e.i(53270);let t="intersectionFunctions",i=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.i(83784),e.i(20385),e.i(82742),e.i(75587);let o="backgroundPixelShader",f=`#include<backgroundUboDeclaration>
...
`;r.ShaderStore.ShadersStoreWGSL[o]||(r.ShaderStore.ShadersStoreWGSL[o]=f),e.s(["backgroundPixelShaderWGSL",0,{name:o,shader:f}],11238)}]);