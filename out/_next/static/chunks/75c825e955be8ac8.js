(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,59791,e=>{"use strict";var i=e.i(47662);let o="meshUboDeclaration",r=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([])},66058,e=>{"use strict";var i=e.i(47662);let o="mainUVVaryingDeclaration",r=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([])},12076,e=>{"use strict";var i=e.i(47662);e.i(84972),e.i(59791);let o="defaultUboDeclaration",r=`layout(std140,column_major) uniform;uniform Material
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([])},58492,e=>{"use strict";var i=e.i(47662);let o="decalFragmentDeclaration",r=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([])},78144,45107,e=>{"use strict";var i=e.i(47662);let o="prePassDeclaration",r=`#ifdef PREPASS
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([],78144);let t="oitDeclaration",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=f),e.s([],45107)},75222,79795,56015,e=>{"use strict";var i=e.i(47662);let o="decalFragment",r=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([],75222);let t="depthPrePass",f=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=f),e.s([],79795);let a="oitFragment",n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([],56015)},5622,e=>{"use strict";var i=e.i(47662);e.i(78153),e.i(95208);let o="lightsFragmentFunctions",r=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([])},4733,e=>{"use strict";var i=e.i(47662);e.i(58492);let o="defaultFragmentDeclaration",r=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.i(12076),e.i(78144),e.i(45107),e.i(66058),e.i(87714),e.i(82656),e.i(31116),e.i(5622),e.i(67654),e.i(30550);let t="fresnelFunction",f=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=f),e.i(35716),e.i(57325),e.i(77772),e.i(37187),e.i(610),e.i(81239),e.i(45224),e.i(71154),e.i(79939),e.i(87126),e.i(75222),e.i(79795),e.i(60096),e.i(49426),e.i(72079),e.i(56015);let a="defaultPixelShader",n=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;i.ShaderStore.ShadersStore[a]||(i.ShaderStore.ShadersStore[a]=n),e.s(["defaultPixelShader",0,{name:a,shader:n}],4733)}]);