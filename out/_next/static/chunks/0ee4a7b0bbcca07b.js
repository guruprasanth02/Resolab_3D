(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,75691,e=>{"use strict";var i=e.i(47662);e.i(87714);let o="iblCdfyPixelShader",r=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;i.ShaderStore.ShadersStore[o]||(i.ShaderStore.ShadersStore[o]=r),e.s(["iblCdfyPixelShader",0,{name:o,shader:r}])}]);