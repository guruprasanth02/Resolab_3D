...
fragmentOutputs.color=textureSampleLevel(textureSampler,textureSamplerSampler,posM,0.0);
#endif
}`;e.ShaderStore.ShadersStoreWGSL[r]||(e.ShaderStore.ShadersStoreWGSL[r]=l),a.s(["fxaaPixelShaderWGSL",0,{name:r,shader:l}])}]);